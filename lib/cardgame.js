...
var cardsConfig = (0, _helper.getConfig)('../config/cardgame.json').cards;
...
var pick = exports.pick = function pick(playerName) {
    ...
    if ((0, _helper.getByName)(players, playerName).length) {
        return false;
    }
...
var summary = exports.summary = function summary(players) {
    return (0, _helper.sortByDeepProp)(players, '.card.rank');
};
...
var gameToSlack = exports.gameToSlack = function gameToSlack(summary) {
    ...
    var reversedSummery = (0, _helper.copyArray)(summary).reverse();
